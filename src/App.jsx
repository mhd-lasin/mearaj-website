          ...
          <div className="container mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
              ...
              <div className="relative img-zoom rounded-sm overflow-hidden shadow-2xl">
                <img src="https://images.unsplash.com/photo-1558171813-4c088753af8f?auto=format&q=80&w=1200"
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6 pt-6 border-t border-brand-gold/20">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-serif font-bold text-brand-black">Master Tailors</h4>
                      <p className="text-sm text-brand-charcoal/60">In-house experts</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-brand-gold rounded-full mt-2"></div>
                    <div>
                      <h4 className="font-serif font-bold text-brand-black">Premium Fabrics</h4>
                      <p className="text-sm text-brand-charcoal/60">Climate-appropriate</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-brand-gold rounded-full mt-2"></div>
                    <div>
                      <h4 className="font-serif font-bold text-brand-black">Perfect Fit</h4>
                      <p className="text-sm text-brand-charcoal/60">Guaranteed precision</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-brand-gold rounded-full mt-2"></div>
                    <div>
                      <h4 className="font-serif font-bold text-brand-black">Heritage</h4>
                      <p className="text-sm text-brand-charcoal/60">Emirati tradition</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section id="services" className="py-20 md:py-32 bg-brand-cream">
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-sm hover-lift border border-brand-gold/10 group">
                <div
                ...
                <h3 className="font-serif text-2xl font-bold text-brand-black mb-3">Ready-Made Kanduras</h3>
                <p className="text-brand-charcoal/70 leading-relaxed mb-4">
                  Curated collection of premium ready-to-wear Kanduras in various sizes and styles. Perfect for
                  immediate needs without compromising on quality or elegance.
                </p>
                <span className="text-brand-gold text-sm font-medium uppercase tracking-wider">Walk-in & Select</span>
              </div>
              ...
              <div className="bg-white p-8 rounded-sm hover-lift border border-brand-gold/10 group">
                ...
                <h3 className="font-serif text-2xl font-bold text-brand-black mb-3">Custom Tailored</h3>
                <p className="text-brand-charcoal/70 leading-relaxed mb-4">
                  Bespoke Kanduras crafted from scratch based on your unique measurements and preferences. From
                  fabric selection to final stitching, every detail is personalized.
                </p>
                <span className="text-brand-gold text-sm font-medium uppercase tracking-wider">By Appointment</span>
              </div>
              ...
              <div className="bg-white p-8 rounded-sm hover-lift border border-brand-gold/10 group">
                ...
                <h3 className="font-serif text-2xl font-bold text-brand-black mb-3">In-House Tailors</h3>
                <p className="text-brand-charcoal/70 leading-relaxed mb-4">
                  Our master craftsmen work on-site, ensuring quality control at every stage. Watch your garment
                  take shape and consult directly with the experts crafting your Kandura.
                </p>
                <span className="text-brand-gold text-sm font-medium uppercase tracking-wider">Expert Craftsmen</span>
              </div>
              ...
              <div className="bg-white p-8 rounded-sm hover-lift border border-brand-gold/10 group">
                ...
                <h3 className="font-serif text-2xl font-bold text-brand-black mb-3">Premium Fabrics</h3>
                <p className="text-brand-charcoal/70 leading-relaxed mb-4">
                  Sourced from the finest mills, our fabrics include lightweight cotton, linen blends, and luxury
                  wool suited for the UAE climate—breathable, durable, and elegant.
                </p>
                <span className="text-brand-gold text-sm font-medium uppercase tracking-wider">Imported & Local</span>
              </div>
              ...
              <div className="bg-white p-8 rounded-sm hover-lift border border-brand-gold/10 group">
                ...
                <h3 className="font-serif text-2xl font-bold text-brand-black mb-3">Perfect Fit Guarantee</h3>
                <p className="text-brand-charcoal/70 leading-relaxed mb-4">
                  We stand by our craftsmanship. Every custom Kandura includes complimentary adjustments to ensure
                  your garment fits flawlessly and feels comfortable all day.
                </p>
                <span className="text-brand-gold text-sm font-medium uppercase tracking-wider">100% Satisfaction</span>
              </div>
              ...
              <div className="bg-white p-8 rounded-sm hover-lift border border-brand-gold/10 group">
                ...
                <h3 className="font-serif text-2xl font-bold text-brand-black mb-3">Expert Alterations</h3>
                <p className="text-brand-charcoal/70 leading-relaxed mb-4">
                  Need adjustments to an existing Kandura? Our tailors provide precise alteration services to
                  perfect the fit of your current garments, regardless of where they were purchased.
                </p>
                <span className="text-brand-gold text-sm font-medium uppercase tracking-wider">Same-Day Available</span>
              </div>
            </div>
          </div>
        </section>
