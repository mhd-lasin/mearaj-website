...
const Footer = () => {
  ...
  const contactDetails = [
    "9FWR+HPC – Sheikh Zayed St",
    "Al Jerf 2, Ajman, UAE",
    "050 439 4512",
    "info@mearaj.com",
    { text: "Sat-Thu: 9AM-1PM, 4:30PM-11:30PM", isExtra: true },
    { text: "Fri: 4:30PM-11:30PM", isExtra: true }
  ];
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <a href={link.href} className="hover:text-brand-gold transition-colors">{link.name}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              {contactDetails.map((detail, index) => (
                <li key={index} className={detail.isExtra ? "pt-2" : ""}>
                  {detail.text || detail}
                </li>
              ))}
            </ul>
